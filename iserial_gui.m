...
% Last Modified by GUIDE v2.5 10-Jan-2024 15:04:01
...
switch arbConfig.model
    ...
    case { 'M8199B', 'M8199B_NONILV', 'M8199B_224GSa' }
        dataRate = 140e9;
        numBits = 1024;
        autoSampleRate = 0;     % at least for the time being
    case { 'M8198A' }
...
if (checkM8195A)
    ...
    if (~strcmp(arbConfig.model, 'M8195A_1ch') && ...
        ...
        ~strcmp(arbConfig.model, 'M8198A') && ...
        isempty(strfind(arbConfig.model, 'M8121A')))
        warndlg('PRBSes > 2^15 are only allowed with M8121A, M8195A, M8198A and large memory');
