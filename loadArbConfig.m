...
% THIS SOFTWARE MAY ONLY BE USED IN CONJUNCTION WITH KEYSIGHT INSTRUMENTS. 
    ...
    arbConfig.channelMask = []; % initialize to avoid doubling every time 
    switch arbConfig.model
        case { 'M933xA' 'M9330A/M9331A' 'N824xA' 'N603xA' }
            ...
            arbConfig.maximumSampleRate = 1.25e9 ./ [1 2 4 8 16];
            arbConfig.minimumSampleRate = 1.25e9 ./ [1 2 4 8 16];
        ...
        case { 'M5300x_baseband' }
            arbConfig.fixedSampleRate = 1;
            arbConfig.defaultSampleRate = 4.8e9;
            arbConfig.maximumSampleRate = 4.8e9;
            arbConfig.minimumSampleRate = 4.8e9;
            arbConfig.minimumSegmentSize = 64;
            arbConfig.maximumSegmentSize = 1024*1024*1024;
            arbConfig.segmentGranularity = 16;
            arbConfig.numChannels = 4;
            arbConfig.maxSegmentNumber = 4096;
        case { 'M5300x_modulated' 'M5300x_std' }
            arbConfig.fixedSampleRate = 1;
            arbConfig.defaultSampleRate = 2.4e9;
            arbConfig.maximumSampleRate = 2.4e9;
            arbConfig.minimumSampleRate = 2.4e9;
            arbConfig.minimumSegmentSize = 64;
            arbConfig.maximumSegmentSize = 1024*1024*1024;
            arbConfig.segmentGranularity = 16;
            arbConfig.numChannels = 4;
        ...
        case { 'M5301x' }
            ...
            arbConfig.maximumSampleRate = 2.4e9;
            arbConfig.minimumSampleRate = 2.4e9;
            arbConfig.minimumSegmentSize = 32;
            arbConfig.maximumSegmentSize = 1024*1024*1024;
        ...
        case { 'M8198A' }
            ...
            arbConfig.minimumSampleRate = 100e9; 
            arbConfig.minimumSegmentSize = 256;
            arbConfig.maximumSegmentSize = 8192*1024*1024;
            arbConfig.segmentGranularity = 256;
            arbConfig.maxSegmentNumber = 1;
            arbConfig.numChannels = 2;
		...
		case { 'M8199A' }
            arbConfig.fixedSampleRate = 0;
            arbConfig.defaultSampleRate = 112e9;
            arbConfig.maximumSampleRate = 130e9;
            arbConfig.minimumSampleRate = 100e9;
            arbConfig.minimumSegmentSize = 256;
            arbConfig.maximumSegmentSize = 512*1024;
            arbConfig.segmentGranularity = 256;
            ...
            arbConfig.numChannels = 4;
            arbConfig.maximumModules = 4;
            arbConfig.bandwidth = 65e9;
        case { 'M8199A_ILV' }
            arbConfig.fixedSampleRate = 0;
            arbConfig.defaultSampleRate = 224e9;
            arbConfig.maximumSampleRate = 260e9;
            arbConfig.minimumSampleRate = 200e9;
            arbConfig.minimumSegmentSize = 512;
            arbConfig.maximumSegmentSize = 2*512*1024;
            arbConfig.segmentGranularity = 512;
            arbConfig.maxSegmentNumber = 1;
            arbConfig.numChannels = 2;
            arbConfig.maximumModules = 4;	
        ...
        case { 'M8199B' }
            arbConfig.fixedSampleRate = 0;
            arbConfig.defaultSampleRate = 256e9;
            arbConfig.maximumSampleRate = 256e9;
            arbConfig.minimumSampleRate = 200e9;
            arbConfig.minimumSegmentSize = 512;
            arbConfig.maximumSegmentSize = 2*512*1024;
            arbConfig.segmentGranularity = 512;
        ...
        case {'M9384B' 'M9384B_1Ch', 'M9384B_2Ch_COH', 'M9383B'}
            ...
            arbConfig.numChannels = 1;
            arbConfig.IQonly = 1;
        case {'M9484C' 'M9484C_1Ch', 'M9484C_2Ch_COH'}
            arbConfig.fixedSampleRate = 1;
            arbConfig.defaultSampleRate = 3E9;
            arbConfig.maximumSampleRate = 3E9;
            arbConfig.minimumSampleRate = 1;
            arbConfig.minimumSegmentSize = 1;
            arbConfig.maximumSegmentSize = 4.096E9;
            arbConfig.segmentGranularity = 512;
            arbConfig.maxSegmentNumber = 65280;
            arbConfig.numChannels = 1;
            arbConfig.IQonly = 1;
        case 'M9484C_2Ch_IND'
            arbConfig.fixedSampleRate = 1;
            ...
            arbConfig.numChannels = 2;
            arbConfig.IQonly = 1;
        case {'S91xxA_RfOutput', 'S91xxA_RRH1_RFHD1', 'S91xxA_RRH1_RFHD2', 'M9410A', 'M9415A'}
            arbConfig.fixedSampleRate = 1;
            arbConfig.defaultSampleRate = 1.5E9;
            arbConfig.maximumSampleRate = 1.5E9;
            arbConfig.minimumSampleRate = 1;
            arbConfig.minimumSegmentSize = 500;
         ...
         case 'S93072B_PNA'
            arbConfig.fixedSampleRate = 0;
            arbConfig.defaultSampleRate = 2.4e9;
            arbConfig.maximumSampleRate = 19.2e9;
            arbConfig.minimumSampleRate = 120e6;
            arbConfig.minimumSegmentSize = 32;
            arbConfig.maximumSegmentSize = 128*1024;
            arbConfig.segmentGranularity = 32;
            arbConfig.maxSegmentNumber = 1;
            arbConfig.SampleRateMultiple = 1;
         case 'M9384B_2Ch_IND'
            arbConfig.fixedSampleRate = 1;
            arbConfig.defaultSampleRate = 2.56E9;
            arbConfig.maximumSampleRate = 2.56E9;
        ...
        case 'DSO90000'
         ...
         case { 'M8135A' }
            arbConfig.fixedSampleRate = 0;
            arbConfig.defaultSampleRate = 64e9;
            arbConfig.maximumSampleRate = 72e9;
            arbConfig.minimumSampleRate = 26e9;
            arbConfig.minimumSegmentSize = 256;
            arbConfig.maximumSegmentSize = 256*1024;
            arbConfig.segmentGranularity = 256;
            arbConfig.maxSegmentNumber = 1;
...
%             arbConfig.numChannels = 2;
    ...
    if (~isfield(arbConfig, 'channelMask') || isempty(arbConfig.channelMask))
    ...
    % if the user has specified a "user-defined default samplerate", use it
    if (isfield(arbConfig, 'userSamplerate'))
        arbConfig.defaultSampleRate = arbConfig.userSamplerate;
    end
