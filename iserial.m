...
if (dataRate * numSamples / numBits > max(arbConfig.maximumSampleRate))
...
if numSamples > 8000000 
    ...
    if (ischar(data) && strncmp(data, 'PRBS', 4))
        iseriallarge(arbConfig, dataRate, spb, data, numBits, format, fct, filename, correction, rtUI, amplitude, arbConfig.segmentGranularity, channelMapping);
    else
