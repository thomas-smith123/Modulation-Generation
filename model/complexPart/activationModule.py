...
# @LastEditTime: 2024-10-24 10:14:38
# @FilePath: /hy_bak_test_delete_after_used/complex_gru_single_radioml/model/complexPart/activationModule.py
...
def complex_sigmoid2(inp):
    ...
    input_real = inp[:, :inp.size(1) // 2, ...]
    input_imag = inp[:, inp.size(1) // 2:, ...]
    return F.sigmoid((input_real+input_imag)/torch.sqrt(torch.tensor(2.0)))
