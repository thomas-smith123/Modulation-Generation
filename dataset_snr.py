...
# @LastEditTime: 2024-10-20 10:47:52
# @FilePath: /hy_bak_test_delete_after_used/complex_gru_single/dataset.py
...
class DatasetWithSNR(Dataset):
    def __init__(self, data, labels):
        self.data = data
        self.labels, self.snr = labels
        self.tensors = (data,self.labels,self.snr)
    def __len__(self):
