...
from model_compare.CDSC_utils import ComplexConv1d, ComplexBatchNorm, CReLU, ComplexAvgPool2d, ComplexLinear, ComplexMaxPool1d
from model_compare.CDSC import CDSC1d
